...
class LoginPage {
  ...
  private static final Set<String> OIDC_PROMPT_NO_BYPASS = Set.of(
    PROMPT_VALUE_LOGIN,
  ...
  boolean shouldByPass() {
    ...
    if (bypassLoginPage) {
      ...
      if (
        SAML_FORCEAUTHN_REQUIREMENT.equalsIgnoreCase(authenticationSession.getAuthNote(SAML_LOGIN_REQUEST_FORCEAUTHN))
      ) {
