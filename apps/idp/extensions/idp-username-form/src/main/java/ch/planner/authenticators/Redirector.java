 ...
 * This fork has been updated on 2024-10-20 by jop
 */
final class Redirector {
  ...
  void redirectTo(IdentityProviderModel idp) {
    ...
    Response response = identityProvider.performLogin(
  ...
  private AuthenticationRequest createAuthenticationRequest(
    ...
    String redirectUri = Urls
      .identityProviderAuthnResponse(keycloakUriInfo.getBaseUri(), providerAlias, realm.getName())
      .toString();
